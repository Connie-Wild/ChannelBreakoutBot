...
class ChannelBreakOut:
    ...
    def describeResult(self):
        ...
        pl, buyEntrySignals, sellEntrySignals, buyCloseSignals, sellCloseSignals, nOfTrade, plPerTrade, tradeLog = self.backtest(judgement, df_candleStick, self.lot, self.rangeTh, self.rangeTerm, self.waitTerm, self.waitTh, self.cost)
